...
def record_replay_2d(*, config: api.GameConfig, seed: int, actions: Iterable[api.Action]) -> ReplayScript2D:
...
def record_replay_nd_ticks(*, config: api.GameConfigND, seed: int, ticks: int) -> ReplayTickScriptND:
