...
_DEFAULT_IO_PATHS = {
    ...
    "paths": {
        ...
        "explorer_topology_preview_cache_dir": "state/topology/cache/explorer_preview",
...
_DEFAULT_CONSTANTS = {
    ...
    "animation": {
        ...
        "endgame": {
            "enabled": True,
            "crack_onset_duration_ms": 190.0,
            "shatter_duration_ms": 1800.0,
            "capture_transition_duration_ms": 1100.0,
            "shell_fragment_lifetime_ms": 1700.0,
            "shell_fade_duration_ms": 580.0,
            "shell_fragment_line_width": 3.0,
            "shell_fragment_speed_min": 1.9,
            "shell_fragment_speed_max": 6.2,
            "shell_artifact_birth_spread_ms": 140.0,
            "shell_artifact_lifetime_min_ms": 720.0,
            "shell_artifact_lifetime_max_ms": 1180.0,
            "shell_artifact_speed_min": 3.0,
            "shell_artifact_speed_max": 6.8,
            "shell_artifact_length_scale": 1.25,
            "grid_break_birth_lead_ms": 90.0,
            "grid_break_lifetime_ms": 860.0,
            "grid_break_residue_alpha": 0.18,
            "grid_break_line_width": 5.0,
            "board_shell_residue_alpha": 0.12,
            "rupture_flash_alpha": 0.22,
            "rupture_flash_duration_ms": 560.0,
            "relic_burst_speed_min": 3.2,
            "relic_burst_speed_max": 7.2,
            "burst_angular_velocity_deg_min": 90.0,
            "burst_angular_velocity_deg_max": 320.0,
            "outward_bias_strength": 1.25,
            "random_spread_strength": 0.78,
            "burst_drag_per_second": 0.84,
            "burst_gravity_per_second": 0.52,
            "relic_spin_deg_min": 12.0,
            "relic_spin_deg_max": 44.0,
            "relic_field_speed_min": 0.42,
            "relic_field_speed_max": 0.96,
            "orbit_radius_min": 0.9,
            "orbit_radius_max": 3.2,
            "orbit_depth_amplitude_min": 0.35,
            "orbit_depth_amplitude_max": 1.8,
            "anchor_spread_radius": 1.7,
            "default_preset_id": "default_orbit",
            "default_boundary_response": "escape",
            "default_particle_collisions": "off",
            "field_extent_multiplier": 1.12,
            "wrap_margin": 0.85,
            "collision_radius_min": 0.34,
            "collision_radius_max": 0.54,
            "collision_restitution": 0.78,
            "collision_damping": 0.92,
            "collision_separation_bias": 1.0,
            "collision_max_relics": 96,
            "collision_velocity_sample_ms": 18.0,
            "path_family_weights": {
                "ellipse": 4,
                "helix": 3,
                "lissajous": 3,
    ...
    "layout": {
        "menu_slider": {
            "track_width_percent": 36,
            "track_min_width": 132,
            "track_preferred_width": 176,
            "track_max_width": 236,
            "track_height": 12,
            "thumb_width": 14,
            "thumb_overhang": 3,
...
def explorer_topology_preview_cache_dir_relative() -> str:
    return _path_value(
        "explorer_topology_preview_cache_dir",
        default_relative="state/topology/cache/explorer_preview",
        required_prefix=state_dir_relative(),
    )
