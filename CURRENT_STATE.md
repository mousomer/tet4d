...
1. `tests/unit/engine/test_topology_lab_menu.py`: `3212` real LOC
...
5. `src/tet4d/ui/pygame/topology_lab/scene_state.py`: `1073` real LOC
6. `src/tet4d/ui/pygame/launch/topology_lab_menu.py`: `1011` real LOC
