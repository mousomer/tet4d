...
3. `tools/governance/validate_project_contracts.py`: `3330` real LOC
...
8. `tests/unit/governance/test_governance_validate_project_contracts.py`: `1790` real LOC
