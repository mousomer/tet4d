...
9. Architecture stage checkpoint (`arch_stage: 176`) routes score-analyzer
   ...
   `src/tet4d/ui/pygame/`, and migrates engine callers to the canonical UI
   launcher import path before shim pruning.
