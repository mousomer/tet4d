...
9. Architecture stage checkpoint (`arch_stage: 134`) routes menu settings state
   JSON reads through `src/tet4d/engine/runtime/menu_settings_state_storage.py`
   before extracting the write path.
