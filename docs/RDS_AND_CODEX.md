...
9. Architecture stage checkpoint (`arch_stage: 174`) routes score-analyzer
   ...
   shim, and adds `engine.api` ND launcher display wrappers for the next UI
   launcher relocation slice.
