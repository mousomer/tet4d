...
9. Architecture stage checkpoint (`arch_stage: 121`) pruned the zero-caller
   `src/tet4d/engine/speed_curve.py` compatibility shim after canonical
   `src/tet4d/engine/gameplay/speed_curve.py` migration.
