...
9. Architecture stage checkpoint (`arch_stage: 133`) routes help-topics JSON
   file reads through `src/tet4d/engine/runtime/help_topics_storage.py`
   before extracting additional runtime state I/O helpers.
