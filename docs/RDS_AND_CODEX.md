...
9. Architecture stage checkpoint (`arch_stage: 127`) pruned the zero-caller
   `src/tet4d/engine/pieces2d.py` compatibility shim after canonical
   `src/tet4d/engine/gameplay/pieces2d.py` migration.
