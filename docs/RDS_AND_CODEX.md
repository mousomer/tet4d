...
9. Architecture stage checkpoint (`arch_stage: 126`) canonicalized engine/CLI/test
   callers to `src/tet4d/engine/gameplay/pieces2d.py` before pruning the
   top-level `src/tet4d/engine/pieces2d.py` compatibility shim.
