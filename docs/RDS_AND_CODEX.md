...
9. Architecture stage checkpoint (`arch_stage: 171`) routes score-analyzer
   ...
   relocation slice, and moves `grid_mode_render` implementation under
   `src/tet4d/ui/pygame/` with an engine compatibility shim.
