...
9. Architecture stage checkpoint (`arch_stage: 125`) pruned the zero-caller
   `src/tet4d/engine/topology.py` compatibility shim after canonical
   `src/tet4d/engine/gameplay/topology.py` migration.
