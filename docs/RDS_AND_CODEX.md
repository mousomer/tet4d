...
9. Architecture stage checkpoint (`arch_stage: 130`) routes keybindings JSON
   file reads through `src/tet4d/engine/runtime/keybindings_storage.py`
   before extracting write paths from `src/tet4d/engine/keybindings.py`.
