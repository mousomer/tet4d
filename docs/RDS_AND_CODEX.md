...
9. Architecture stage checkpoint (`arch_stage: 129`) pruned the zero-caller
   `src/tet4d/engine/pieces_nd.py` compatibility shim after canonical
   `src/tet4d/engine/gameplay/pieces_nd.py` migration.
