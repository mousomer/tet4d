...
9. Architecture stage checkpoint (`arch_stage: 175`) routes score-analyzer
   ...
   launcher relocation slice, and moves `launcher_nd_runner` implementation
   under `src/tet4d/ui/pygame/` with an engine compatibility shim.
