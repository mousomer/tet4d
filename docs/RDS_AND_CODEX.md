...
9. Architecture stage checkpoint (`arch_stage: 123`) pruned the zero-caller
   `src/tet4d/engine/topology_designer.py` compatibility shim after canonical
   `src/tet4d/engine/gameplay/topology_designer.py` migration.
