...
9. Architecture stage checkpoint (`arch_stage: 119`) pruned the zero-caller
   `src/tet4d/engine/exploration_mode.py` compatibility shim after canonical
   `src/tet4d/engine/gameplay/exploration_mode.py` migration.
