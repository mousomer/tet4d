...
9. Architecture stage checkpoint (`arch_stage: 124`) migrates engine/CLI/test
   callers to canonical `src/tet4d/engine/gameplay/topology.py` before pruning
   the top-level compatibility shim.
