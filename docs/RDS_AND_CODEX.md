...
9. Architecture stage checkpoint (`arch_stage: 166`) routes score-analyzer
   ...
   engine/CLI callers to the canonical `engine.ui_logic.view_modes` import
   path before shim pruning.
