...
9. Architecture stage checkpoint (`arch_stage: 128`) canonicalized engine/test
   callers to `src/tet4d/engine/gameplay/pieces_nd.py` before pruning the
   top-level `src/tet4d/engine/pieces_nd.py` compatibility shim.
