...
9. Architecture stage checkpoint (`arch_stage: 120`) migrates engine/test
   callers to canonical `src/tet4d/engine/gameplay/speed_curve.py` before
   pruning the top-level compatibility shim.
