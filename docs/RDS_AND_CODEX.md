...
9. Architecture stage checkpoint (`arch_stage: 122`) migrates engine/CLI/test
   callers to canonical `src/tet4d/engine/gameplay/topology_designer.py`
   before pruning the top-level compatibility shim.
