...
- `animation.endgame.grid_break_lifetime_ms`: `560.0` (`float`)
...
- `animation.endgame.outward_bias_strength`: `1.0` (`float`)
...
- `animation.endgame.random_spread_strength`: `0.65` (`float`)
...
- `animation.endgame.shell_artifact_lifetime_max_ms`: `980.0` (`float`)
- `animation.endgame.shell_artifact_lifetime_min_ms`: `620.0` (`float`)
- `animation.endgame.shell_fade_duration_ms`: `580.0` (`float`)
- `animation.endgame.shell_fragment_lifetime_ms`: `1700.0` (`float`)
- `animation.endgame.shell_fragment_speed_max`: `4.9` (`float`)
- `animation.endgame.shell_fragment_speed_min`: `1.4` (`float`)
