...
- `ui_copy.settings_hub.hints[]`: array[`string`]; examples: `"Up/Down select   Left/Right adjust   Enter activate"`, `"Enter on width/height/seed to type large numeric values"`, `"Gameplay -> Advanced gameplay... controls kick permissiveness, auto ...`
...
- `animation.piece_rotation_duration_ms`: `150.0` (`float`)
