...
- `governance.godot_toolchain.results.known_limitations[]`: array[`string`]; examples: `"macOS is the local development evidence platform"`, `"Linux acceptance for this upgrade is deferred to CI on publication r...`, `"Windows native packaging remains declared but unverified"`
