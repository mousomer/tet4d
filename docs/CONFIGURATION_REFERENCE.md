...
- `events.endgame_boom.amplitude`: `0.13` (`float`)
- `events.endgame_boom.duration_ms`: `146` (`int`)
- `events.endgame_boom.frequency_hz`: `170.0` (`float`)
- `events.endgame_crack.amplitude`: `0.08` (`float`)
- `events.endgame_crack.duration_ms`: `42` (`int`)
- `events.endgame_crack.frequency_hz`: `920.0` (`float`)
...
### `config/governance/project.json`
Top-level keys: `authorities`, `canonical_owner_set`, `environment`, `execution`, `generated_surfaces`, `project`, `required_authorities`, `role_bootstrap`, `routes`, `sanitation`, `schema_version`, `verification`
Parameters:
...
- `authorities[].exclusive`: varies (`bool`); examples: `true`, `false`
...
- `authorities[].source_type`: varies (`string`); examples: `"file"`, `"alias"`, `"directory"`
- `canonical_owner_set.authority_ref`: `"legacy-policy-pack"` (`string`)
- `canonical_owner_set.json_pointer`: `"/authority_model/canonical_human_owners"` (`string`)
...
- `required_authorities[]`: array[`string`]; examples: `"native-and-platform"`, `"authority-transfer"`
...
Parameters:
- `content_sha256`: `"c6470f9b5dd3922d844da8afe46f90d796f93f795dbba23512c6ae0778fef031"` (`string`)
...
- `revision`: `"v0.4-telemetry-core-4"` (`string`)
- `schema_version`: `1` (`int`)
...
### `config/menu/defaults.json`
Top-level keys: `active_profile`, `analytics`, `audio`, `display`, `explosion_defaults`, `last_mode`, `settings`, `version`
Parameters:
...
- `explosion_defaults.2d.base_mass`: `1.0` (`float`)
...
- `explosion_defaults.2d.random_mass_max`: `1.25` (`float`)
- `explosion_defaults.2d.random_mass_min`: `0.75` (`float`)
- `explosion_defaults.2d.seed`: `1337` (`int`)
- `explosion_defaults.2d.shadow_mode`: `"off"` (`string`)
- `explosion_defaults.2d.snapshot_source_id`: `"single_piece"` (`string`)
- `explosion_defaults.2d.sound_enabled`: `true` (`bool`)
- `explosion_defaults.2d.speed_preset`: `"normal"` (`string`)
- `explosion_defaults.2d.topology_preset_id`: `""` (`string`)
- `explosion_defaults.2d.trace_enabled`: `false` (`bool`)
- `explosion_defaults.2d.trace_retention_ms`: `2640.0` (`float`)
- `explosion_defaults.2d.view_mode`: `"board_native"` (`string`)
- `explosion_defaults.2d.w_movement_animation_style`: `"fade"` (`string`)
- `explosion_defaults.3d.base_mass`: `1.0` (`float`)
...
- `explosion_defaults.3d.random_mass_max`: `1.25` (`float`)
- `explosion_defaults.3d.random_mass_min`: `0.75` (`float`)
- `explosion_defaults.3d.seed`: `1337` (`int`)
- `explosion_defaults.3d.shadow_mode`: `"off"` (`string`)
- `explosion_defaults.3d.snapshot_source_id`: `"single_piece"` (`string`)
- `explosion_defaults.3d.sound_enabled`: `true` (`bool`)
- `explosion_defaults.3d.speed_preset`: `"normal"` (`string`)
- `explosion_defaults.3d.topology_preset_id`: `""` (`string`)
- `explosion_defaults.3d.trace_enabled`: `false` (`bool`)
- `explosion_defaults.3d.trace_retention_ms`: `2640.0` (`float`)
- `explosion_defaults.3d.view_mode`: `"board_native"` (`string`)
- `explosion_defaults.3d.w_movement_animation_style`: `"fade"` (`string`)
- `explosion_defaults.4d.base_mass`: `1.0` (`float`)
...
- `explosion_defaults.4d.random_mass_max`: `1.25` (`float`)
- `explosion_defaults.4d.random_mass_min`: `0.75` (`float`)
- `explosion_defaults.4d.seed`: `1337` (`int`)
- `explosion_defaults.4d.shadow_mode`: `"off"` (`string`)
- `explosion_defaults.4d.snapshot_source_id`: `"single_piece"` (`string`)
- `explosion_defaults.4d.sound_enabled`: `true` (`bool`)
- `explosion_defaults.4d.speed_preset`: `"normal"` (`string`)
- `explosion_defaults.4d.topology_preset_id`: `""` (`string`)
- `explosion_defaults.4d.trace_enabled`: `false` (`bool`)
- `explosion_defaults.4d.trace_retention_ms`: `2640.0` (`float`)
...
### `config/menu/structure.json`
Top-level keys: `bot_options_rows`, `branding`, `launcher_route_actions`, `launcher_subtitles`, `menu_entrypoints`, `menus`, `pause_copy`, `pause_menu_actions`, `pause_menu_rows`, `settings_category_docs`, `settings_category_metrics`, `settings_option_labels`, `settings_split_rules`, `setup_fields`, `setup_hints`, `ui_copy`
Parameters:
...
- `menu_entrypoints.settings`: `"settings_root"` (`string`)
- `menus.keybindings_root.items[]`: array[`object`]
- `menus.keybindings_root.items[].description`: varies (`string`); examples: `"Shared system bindings used across dimensions."`, `"2D gameplay and explorer bindings."`, `"3D gameplay, explorer, and camera bindings."`
- `menus.keybindings_root.items[].id`: varies (`string`); examples: `"keybindings_scope_general"`, `"keybindings_scope_2d"`, `"keybindings_scope_3d"`
- `menus.keybindings_root.items[].label`: varies (`string`); examples: `"General"`, `"2D"`, `"3D"`
- `menus.keybindings_root.items[].menu_id`: varies (`string`); examples: `"keybindings_scope_general"`, `"keybindings_scope_2d"`, `"keybindings_scope_3d"`
- `menus.keybindings_root.items[].type`: varies (`string`); examples: `"submenu"`
- `menus.keybindings_root.title`: `"Keybindings"` (`string`)
- `menus.keybindings_scope_2d.items[]`: array[`object`]
- `menus.keybindings_scope_2d.items[].binding_bucket`: varies (`string`); examples: `"translation"`, `"rotation"`, `"other"`
- `menus.keybindings_scope_2d.items[].binding_dimension`: varies (`string`); examples: `"2d"`
- `menus.keybindings_scope_2d.items[].binding_group`: varies (`string`); examples: `"game"`, `"explorer"`
- `menus.keybindings_scope_2d.items[].description`: varies (`string`); examples: `"Movement, drop, and transport bindings."`, `"Rotation and orientation bindings."`, `"Gameplay actions outside translation and rotation."`
- `menus.keybindings_scope_2d.items[].id`: varies (`string`); examples: `"2d_game_translation"`, `"2d_game_rotation"`, `"2d_game_other"`
- `menus.keybindings_scope_2d.items[].label`: varies (`string`); examples: `"2D Gameplay / Translation"`, `"2D Gameplay / Rotation"`, `"2D Gameplay / Other"`
- `menus.keybindings_scope_2d.items[].type`: varies (`string`); examples: `"keybinding_group"`
- `menus.keybindings_scope_2d.title`: `"2D"` (`string`)
- `menus.keybindings_scope_3d.items[]`: array[`object`]
- `menus.keybindings_scope_3d.items[].binding_bucket`: varies (`string`); examples: `"translation"`, `"rotation"`, `"other"`
- `menus.keybindings_scope_3d.items[].binding_dimension`: varies (`string`); examples: `"3d"`
- `menus.keybindings_scope_3d.items[].binding_group`: varies (`string`); examples: `"game"`, `"explorer"`, `"camera"`
- `menus.keybindings_scope_3d.items[].description`: varies (`string`); examples: `"Movement, drop, and transport bindings."`, `"Rotation and orientation bindings."`, `"Gameplay actions outside translation and rotation."`
- `menus.keybindings_scope_3d.items[].id`: varies (`string`); examples: `"3d_game_translation"`, `"3d_game_rotation"`, `"3d_game_other"`
- `menus.keybindings_scope_3d.items[].label`: varies (`string`); examples: `"3D Gameplay / Translation"`, `"3D Gameplay / Rotation"`, `"3D Gameplay / Other"`
- `menus.keybindings_scope_3d.items[].type`: varies (`string`); examples: `"keybinding_group"`
- `menus.keybindings_scope_3d.title`: `"3D"` (`string`)
- `menus.keybindings_scope_4d.items[]`: array[`object`]
- `menus.keybindings_scope_4d.items[].binding_bucket`: varies (`string`); examples: `"translation"`, `"rotation"`, `"other"`
- `menus.keybindings_scope_4d.items[].binding_dimension`: varies (`string`); examples: `"4d"`
- `menus.keybindings_scope_4d.items[].binding_group`: varies (`string`); examples: `"game"`, `"explorer"`, `"camera"`
- `menus.keybindings_scope_4d.items[].description`: varies (`string`); examples: `"Movement, drop, and transport bindings."`, `"Rotation and orientation bindings."`, `"Gameplay actions outside translation and rotation."`
- `menus.keybindings_scope_4d.items[].id`: varies (`string`); examples: `"4d_game_translation"`, `"4d_game_rotation"`, `"4d_game_other"`
- `menus.keybindings_scope_4d.items[].label`: varies (`string`); examples: `"4D Gameplay / Translation"`, `"4D Gameplay / Rotation"`, `"4D Gameplay / Other"`
- `menus.keybindings_scope_4d.items[].type`: varies (`string`); examples: `"keybinding_group"`
- `menus.keybindings_scope_4d.title`: `"4D"` (`string`)
- `menus.keybindings_scope_all.items[]`: array[`object`]
- `menus.keybindings_scope_all.items[].binding_bucket`: varies (`string`); examples: `"all"`, `"translation"`, `"rotation"`
- `menus.keybindings_scope_all.items[].binding_dimension`: varies (`string`); examples: `"2d"`, `"3d"`, `"4d"`
- `menus.keybindings_scope_all.items[].binding_group`: varies (`string`); examples: `"system"`, `"game"`, `"explorer"`
- `menus.keybindings_scope_all.items[].description`: varies (`string`); examples: `"Menu, profile, and shared command bindings."`, `"Movement, drop, and transport bindings."`, `"Rotation and orientation bindings."`
- `menus.keybindings_scope_all.items[].id`: varies (`string`); examples: `"all_system"`, `"all_2d_game_translation"`, `"all_2d_game_rotation"`
...
- `menus.keybindings_scope_general.items[].binding_group`: `"system"` (`string`)
- `menus.keybindings_scope_general.items[].description`: `"Menu, profile, and shared command bindings."` (`string`)
- `menus.keybindings_scope_general.items[].id`: `"general_system"` (`string`)
...
- `menus.launcher_tutorials.items[].id`: varies (`string`); examples: `"interactive_tutorials"`, `"tutorial_how_to_play"`, `"tutorial_controls_reference"`
...
- `menus.launcher_tutorials_interactive.items[].id`: varies (`string`); examples: `"tutorial_2d"`, `"tutorial_3d"`, `"tutorial_4d"`
...
- `menus.pause_root.items[].id`: varies (`string`); examples: `"resume"`, `"restart"`, `"settings"`
...
- `menus.settings_audio.items[]`: array[`object`]
...
- `animation.endgame.anchor_spread_radius`: `1.7` (`float`)
- `animation.endgame.board_shard_alpha`: `0.45` (`float`)
- `animation.endgame.board_shard_cap_2d`: `32` (`int`)
- `animation.endgame.board_shard_cap_3d`: `48` (`int`)
- `animation.endgame.board_shard_cap_4d`: `64` (`int`)
- `animation.endgame.board_shard_lifetime_max_ms`: `2600.0` (`float`)
- `animation.endgame.board_shard_lifetime_min_ms`: `1200.0` (`float`)
- `animation.endgame.board_shard_speed_max`: `4.0` (`float`)
- `animation.endgame.board_shard_speed_min`: `1.2` (`float`)
- `animation.endgame.board_shard_spin_max_deg_per_s`: `240.0` (`float`)
- `animation.endgame.board_shard_spin_min_deg_per_s`: `-240.0` (`float`)
- `animation.endgame.board_shell_residue_alpha`: `0.12` (`float`)
- `animation.endgame.boundary_impact_cap_2d`: `24` (`int`)
- `animation.endgame.boundary_impact_cap_3d`: `32` (`int`)
- `animation.endgame.boundary_impact_cap_4d`: `40` (`int`)
- `animation.endgame.burst_angular_velocity_deg_max`: `320.0` (`float`)
- `animation.endgame.burst_angular_velocity_deg_min`: `90.0` (`float`)
- `animation.endgame.burst_drag_per_second`: `0.84` (`float`)
- `animation.endgame.burst_gravity_per_second`: `0.52` (`float`)
- `animation.endgame.capture_transition_duration_ms`: `1100.0` (`float`)
- `animation.endgame.collision_damping`: `0.92` (`float`)
- `animation.endgame.collision_max_relics`: `96` (`int`)
- `animation.endgame.collision_radius_max`: `0.54` (`float`)
- `animation.endgame.collision_radius_min`: `0.34` (`float`)
- `animation.endgame.collision_restitution`: `0.78` (`float`)
- `animation.endgame.collision_separation_bias`: `1.0` (`float`)
- `animation.endgame.collision_velocity_sample_ms`: `18.0` (`float`)
- `animation.endgame.crack_onset_duration_ms`: `190.0` (`float`)
- `animation.endgame.cracked_board_residue_alpha`: `0.14` (`float`)
...
- `animation.endgame.grid_break_birth_lead_ms`: `90.0` (`float`)
- `animation.endgame.grid_break_lifetime_ms`: `860.0` (`float`)
- `animation.endgame.grid_break_line_width`: `5.0` (`float`)
- `animation.endgame.grid_break_residue_alpha`: `0.18` (`float`)
- `animation.endgame.impact_flash_duration_ms`: `260.0` (`float`)
- `animation.endgame.impact_flash_radius`: `5.0` (`float`)
- `animation.endgame.impact_streak_lifetime_ms`: `650.0` (`float`)
- `animation.endgame.impact_streak_width`: `3.5` (`float`)
- `animation.endgame.orbit_depth_amplitude_max`: `1.8` (`float`)
- `animation.endgame.orbit_depth_amplitude_min`: `0.35` (`float`)
- `animation.endgame.orbit_radius_max`: `3.2` (`float`)
- `animation.endgame.orbit_radius_min`: `0.9` (`float`)
- `animation.endgame.outward_bias_strength`: `1.25` (`float`)
- `animation.endgame.path_family_weights.ellipse`: `4` (`int`)
- `animation.endgame.path_family_weights.helix`: `3` (`int`)
- `animation.endgame.path_family_weights.lissajous`: `3` (`int`)
- `animation.endgame.presets.default_orbit.drift_scale`: `0.18` (`float`)
- `animation.endgame.presets.default_orbit.extent_scale`: `1.0` (`float`)
- `animation.endgame.presets.default_orbit.oscillation_scale`: `1.0` (`float`)
- `animation.endgame.presets.invert_all.drift_scale`: `0.84` (`float`)
- `animation.endgame.presets.invert_all.extent_scale`: `1.02` (`float`)
- `animation.endgame.presets.invert_all.oscillation_scale`: `0.56` (`float`)
- `animation.endgame.presets.sphere.drift_scale`: `0.34` (`float`)
- `animation.endgame.presets.sphere.extent_scale`: `1.0` (`float`)
- `animation.endgame.presets.sphere.oscillation_scale`: `0.46` (`float`)
- `animation.endgame.presets.sphere.radial_correction_strength`: `0.42` (`float`)
- `animation.endgame.presets.sphere.sphere_radius_scale`: `0.92` (`float`)
- `animation.endgame.presets.sphere.tangential_bias`: `1.08` (`float`)
- `animation.endgame.presets.wrap_all.drift_scale`: `0.92` (`float`)
- `animation.endgame.presets.wrap_all.extent_scale`: `1.08` (`float`)
- `animation.endgame.presets.wrap_all.oscillation_scale`: `0.62` (`float`)
- `animation.endgame.random_spread_strength`: `0.78` (`float`)
- `animation.endgame.relic_burst_speed_max`: `7.2` (`float`)
- `animation.endgame.relic_burst_speed_min`: `3.2` (`float`)
- `animation.endgame.relic_field_speed_max`: `0.96` (`float`)
- `animation.endgame.relic_field_speed_min`: `0.42` (`float`)
- `animation.endgame.relic_spin_deg_max`: `44.0` (`float`)
- `animation.endgame.relic_spin_deg_min`: `12.0` (`float`)
- `animation.endgame.rupture_flash_alpha`: `0.22` (`float`)
- `animation.endgame.rupture_flash_duration_ms`: `560.0` (`float`)
- `animation.endgame.seed_salt`: `7919` (`int`)
- `animation.endgame.shatter_duration_ms`: `1800.0` (`float`)
- `animation.endgame.shell_artifact_birth_spread_ms`: `140.0` (`float`)
- `animation.endgame.shell_artifact_length_scale`: `1.25` (`float`)
- `animation.endgame.shell_artifact_lifetime_max_ms`: `1180.0` (`float`)
- `animation.endgame.shell_artifact_lifetime_min_ms`: `720.0` (`float`)
- `animation.endgame.shell_artifact_speed_max`: `6.8` (`float`)
- `animation.endgame.shell_artifact_speed_min`: `3.0` (`float`)
- `animation.endgame.shell_event_delay_max_ms`: `180.0` (`float`)
- `animation.endgame.shell_event_hold_ms`: `1150.0` (`float`)
- `animation.endgame.shell_event_impact_flash_radius`: `6.0` (`float`)
- `animation.endgame.shell_event_impact_window_ms`: `420.0` (`float`)
- `animation.endgame.shell_event_proxy_impact_progress_max`: `0.92` (`float`)
- `animation.endgame.shell_event_proxy_impact_progress_min`: `0.78` (`float`)
- `animation.endgame.shell_event_proxy_rotation_deg`: `28.0` (`float`)
- `animation.endgame.shell_event_proxy_scale_peak`: `1.18` (`float`)
- `animation.endgame.shell_event_proxy_tangent_jitter`: `0.22` (`float`)
- `animation.endgame.shell_event_residue_alpha`: `0.14` (`float`)
- `animation.endgame.shell_event_rupture_ms`: `1250.0` (`float`)
- `animation.endgame.shell_event_shard_drift_ms`: `2400.0` (`float`)
- `animation.endgame.shell_event_streak_width`: `3.5` (`float`)
- `animation.endgame.shell_fade_duration_ms`: `580.0` (`float`)
- `animation.endgame.shell_fragment_lifetime_ms`: `1700.0` (`float`)
- `animation.endgame.shell_fragment_line_width`: `3.0` (`float`)
- `animation.endgame.shell_fragment_speed_max`: `6.2` (`float`)
- `animation.endgame.shell_fragment_speed_min`: `1.9` (`float`)
- `animation.endgame.shell_preview_default_time_scale`: `1.0` (`float`)
- `animation.endgame.shell_preview_hold_ms`: `1000.0` (`float`)
- `animation.endgame.shell_preview_rupture_ms`: `1100.0` (`float`)
- `animation.endgame.shell_preview_shard_drift_ms`: `2200.0` (`float`)
- `animation.endgame.wrap_margin`: `0.85` (`float`)
...
- `layout.menu_scrollbar.gap`: `12` (`int`)
- `layout.menu_scrollbar.min_handle_height`: `28` (`int`)
- `layout.menu_scrollbar.track_padding`: `4` (`int`)
- `layout.menu_scrollbar.width`: `12` (`int`)
- `layout.menu_slider.label_min_width`: `104` (`int`)
- `layout.menu_slider.row_bottom_padding`: `10` (`int`)
- `layout.menu_slider.slider_gap`: `16` (`int`)
- `layout.menu_slider.slider_top_gap`: `8` (`int`)
- `layout.menu_slider.text_gap`: `12` (`int`)
- `layout.menu_slider.text_top_padding`: `4` (`int`)
- `layout.menu_slider.thumb_overhang`: `3` (`int`)
- `layout.menu_slider.thumb_width`: `14` (`int`)
- `layout.menu_slider.track_height`: `12` (`int`)
- `layout.menu_slider.track_max_width`: `236` (`int`)
- `layout.menu_slider.track_min_width`: `132` (`int`)
- `layout.menu_slider.track_preferred_width`: `176` (`int`)
- `layout.menu_slider.track_width_percent`: `36` (`int`)
- `layout.menu_slider.value_max_width`: `196` (`int`)
- `layout.menu_slider.value_min_width`: `96` (`int`)
...
- `tracked_leaf_folders[].baseline_score`: varies (`float`); examples: `1.0`, `0.93`, `0.88`
...
- `code_rules.dead_code.duplicate_functions.max_allowed_duplicates_per_signature`: `1` (`int`)
- `code_rules.dead_code.duplicate_functions.min_body_lines`: `12` (`int`)
- `code_rules.dead_code.duplicate_functions.strict_scope_globs[]`: array[`string`]; examples: `"tools/governance/*.py"`
- `code_rules.dead_code.forbidden_paths[]`: array[`string`]; examples: `"tetris_nd/"`
- `code_rules.dead_code.todo_rule.ignore_globs[]`: array[`string`]; examples: `"tools/governance/check_dedup_dead_code_rules.py"`, `"tests/**/*.py"`
...
- `code_rules.loc_guidance.buckets.tools_scripts`: `"tools/|scripts/"` (`string`)
- `code_rules.loc_guidance.default_batch_type`: `"mixed"` (`string`)
- `code_rules.loc_guidance.include_extensions[]`: array[`string`]; examples: `".py"`
- `code_rules.loc_guidance.mode`: `"soft_warning"` (`string`)
- `code_rules.loc_guidance.thresholds.bugfix.src`: `250` (`int`)
- `code_rules.loc_guidance.thresholds.bugfix.tests`: `150` (`int`)
- `code_rules.loc_guidance.thresholds.bugfix.tools_scripts`: `120` (`int`)
- `code_rules.loc_guidance.thresholds.feature.src`: `500` (`int`)
- `code_rules.loc_guidance.thresholds.feature.tests`: `250` (`int`)
- `code_rules.loc_guidance.thresholds.feature.tools_scripts`: `150` (`int`)
- `code_rules.loc_guidance.thresholds.governance.src`: `0` (`int`)
- `code_rules.loc_guidance.thresholds.governance.tests`: `80` (`int`)
- `code_rules.loc_guidance.thresholds.governance.tools_scripts`: `200` (`int`)
- `code_rules.loc_guidance.thresholds.mixed.src`: `300` (`int`)
- `code_rules.loc_guidance.thresholds.mixed.tests`: `180` (`int`)
- `code_rules.loc_guidance.thresholds.mixed.tools_scripts`: `120` (`int`)
- `code_rules.loc_guidance.thresholds.refactor_only.src`: `0` (`int`)
- `code_rules.loc_guidance.thresholds.refactor_only.tests`: `0` (`int`)
- `code_rules.loc_guidance.thresholds.refactor_only.tools_scripts`: `0` (`int`)
- `code_rules.magic_numbers.entrypoints[]`: array[`object`]
- `code_rules.magic_numbers.entrypoints[].forbidden_regex[]`: array[`empty, string`]; examples: `"\\b999_?999_?999\\b"`, `"\\b0\\.85\\b"`
- `code_rules.magic_numbers.entrypoints[].path`: varies (`string`); examples: `"src/tet4d/ui/pygame/launch/settings_hub_actions.py"`, `"src/tet4d/engine/runtime/settings_schema.py"`
- `code_rules.magic_numbers.entrypoints[].required_all_tokens[]`: array[`string`]; examples: `"clamp_game_seed"`, `"clamp_overlay_transparency"`, `"clamp_lines_per_level"`
- `code_rules.magic_numbers.entrypoints[].severity`: varies (`string`); examples: `"error"`, `"warning"`
- `code_rules.sanitation.entrypoints[]`: array[`object`]
- `code_rules.sanitation.entrypoints[].path`: varies (`string`); examples: `"src/tet4d/ui/pygame/launch/settings_hub_actions.py"`, `"src/tet4d/ui/pygame/menu/keybindings_menu.py"`, `"src/tet4d/ui/pygame/launch/leaderboard_menu.py"`
- `code_rules.sanitation.entrypoints[].required_all_tokens[]`: array[`string`]; examples: `"append_numeric_text"`, `"parse_numeric_text"`, `"_sanitize_profile_name"`
...
- `code_rules.wheel_reuse.rules[].description`: varies (`string`); examples: `"Prefer stdlib or existing repo helpers for parsing and validation ra...`, `"Do not duplicate local sanitization and normalization pipelines wher...`, `"Use existing project config, path, and JSON helper flows before intr...`
- `code_rules.wheel_reuse.rules[].forbidden_regex[]`: array[`string`]; examples: `"\\.strip\\(\\)\\.lower\\(\\)\\s+in\\s+\\([^)]+\\)"`, `"if\\s+[^\\n]+\\.isdigit\\(\\)\\s*:\\s*return\\s+int\\("`, `"if\\s+[^\\n]+\\.isnumeric\\(\\)\\s*:\\s*return\\s+int\\("`
...
- `governance.architecture.backlog.mode`: `"tet4d_bkl"` (`string`)
- `governance.architecture.boundary_scripts[]`: array[`string`]; examples: `"scripts/check_architecture_boundaries.sh"`, `"scripts/check_engine_core_purity.sh"`
- `governance.architecture.class_gate_eligibility.code_default`: `true` (`bool`)
- `governance.architecture.class_gate_eligibility.micro_core_leaf`: `true` (`bool`)
- `governance.architecture.class_gate_eligibility.micro_feature_leaf`: `true` (`bool`)
- `governance.architecture.class_gate_eligibility.non_code_exempt`: `false` (`bool`)
- `governance.architecture.class_gate_eligibility.tests_lenient`: `true` (`bool`)
- `governance.architecture.class_to_profile.code_default`: `"default_leaf"` (`string`)
- `governance.architecture.class_to_profile.micro_core_leaf`: `"micro_leaf"` (`string`)
- `governance.architecture.class_to_profile.micro_feature_leaf`: `"micro_leaf"` (`string`)
- `governance.architecture.class_to_profile.non_code_exempt`: `"non_code_exempt"` (`string`)
- `governance.architecture.class_to_profile.tests_lenient`: `"tests_leaf"` (`string`)
- `governance.architecture.classification.class_overrides.src/tet4d/engine/core/rng`: `"micro_core_leaf"` (`string`)
- `governance.architecture.classification.class_overrides.src/tet4d/engine/core/step`: `"micro_core_leaf"` (`string`)
- `governance.architecture.classification.class_overrides.src/tet4d/engine/runtime/menu_settings`: `"micro_feature_leaf"` (`string`)
- `governance.architecture.classification.class_overrides.src/tet4d/engine/runtime/menu_structure`: `"micro_feature_leaf"` (`string`)
- `governance.architecture.classification.class_overrides.src/tet4d/engine/runtime/score_analysis`: `"micro_feature_leaf"` (`string`)
- `governance.architecture.classification.class_overrides.src/tet4d/replay`: `"micro_feature_leaf"` (`string`)
- `governance.architecture.classification.class_overrides.tests/unit/engine`: `"tests_lenient"` (`string`)
- `governance.architecture.classification.gate_overrides.tests/unit/engine`: `true` (`bool`)
- `governance.architecture.classification.non_code_segments[]`: array[`string`]; examples: `"docs"`, `"doc"`, `"assets"`
- `governance.architecture.classification.test_segments[]`: array[`string`]; examples: `"test"`, `"tests"`
- `governance.architecture.forbidden_reverse_imports[]`: array[`object`]
- `governance.architecture.forbidden_reverse_imports[].from`: varies (`string`); examples: `"tet4d.engine"`
- `governance.architecture.forbidden_reverse_imports[].to`: varies (`string`); examples: `"tet4d.ui"`, `"tet4d.ai"`, `"tet4d.replay"`
- `governance.architecture.long_term_goals.keybinding_retention.required_scopes[]`: array[`string`]; examples: `"general"`, `"2d"`, `"3d"`
- `governance.architecture.long_term_goals.keybinding_retention.target_pressure_max`: `0.0` (`float`)
- `governance.architecture.long_term_goals.menu_simplification.target_simplification_score_min`: `0.65` (`float`)
- `governance.architecture.schema_version`: `1` (`int`)
- `governance.architecture.source_roots[]`: array[`string`]; examples: `"src/tet4d"`, `"tests"`, `"tools"`
- `governance.architecture.zero_budgets.engine_core_purity_violations`: `0` (`int`)
- `governance.architecture.zero_budgets.engine_core_to_non_core_imports`: `0` (`int`)
...
- `governance.contracts.replay_manifest`: `"config/project/policy/manifests/replay_manifest.json"` (`string`)
- `governance.contracts.secret_scan`: `"config/project/policy/manifests/secret_scan.json"` (`string`)
- `governance.contributor_directives.directives[]`: array[`object`]
...
- `governance.drift_protection.schema_version`: `1` (`int`)
- `governance.drift_protection.thin_wrapper_budgets[]`: array[`object`]
- `governance.drift_protection.thin_wrapper_budgets[].max_real_loc`: varies (`int`); examples: `840`, `24`, `160`
- `governance.drift_protection.thin_wrapper_budgets[].path`: varies (`string`); examples: `"cli/front.py"`, `"cli/front2d.py"`, `"cli/front3d.py"`
- `governance.drift_protection.thin_wrapper_budgets[].role`: varies (`string`); examples: `"compatibility launcher wrapper"`, `"thin 2D launcher shim"`, `"thin 3D launcher shim"`
- `governance.drift_protection.tutorial_copy_contract.forbidden_prefixes[]`: array[`string`]; examples: `"Goal:"`, `"Action:"`
...
- `governance.godot_toolchain.assets.linux_x86_64.executable`: `"Godot_v4.7.2-stable_linux.x86_64"` (`string`)
- `governance.godot_toolchain.assets.linux_x86_64.name`: `"Godot_v4.7.2-stable_linux.x86_64.zip"` (`string`)
- `governance.godot_toolchain.assets.linux_x86_64.sha256`: `"cadd3204e728a35d3f13adb7fd0d7902636b79f6b95c40c265eb73b6c35329e4"` (`string`)
- `governance.godot_toolchain.assets.linux_x86_64.url`: `"https://github.com/godotengine/godot/releases/download/4.7.2-stable/...` (`string`)
- `governance.godot_toolchain.assets.macos_universal.executable`: `"Godot.app/Contents/MacOS/Godot"` (`string`)
- `governance.godot_toolchain.assets.macos_universal.name`: `"Godot_v4.7.2-stable_macos.universal.zip"` (`string`)
- `governance.godot_toolchain.assets.macos_universal.sha256`: `"c58a24e31d720be9d62f60cb5627c4e695fb72f21b0cfe1bc9ccaa9a3b3ba63e"` (`string`)
- `governance.godot_toolchain.assets.macos_universal.url`: `"https://github.com/godotengine/godot/releases/download/4.7.2-stable/...` (`string`)
- `governance.godot_toolchain.assets.windows_x86_64.executable`: `"Godot_v4.7.2-stable_win64.exe"` (`string`)
- `governance.godot_toolchain.assets.windows_x86_64.name`: `"Godot_v4.7.2-stable_win64.exe.zip"` (`string`)
...
- `governance.godot_toolchain.canonical_commands.windows_release_export`: `"GODOT_BIN=/path/to/Godot ./packaging/godot/build_windows.sh"` (`string`)
- `governance.godot_toolchain.engine_commit`: `"ed1daf0bf001b61586d9930840f2f1394092c079"` (`string`)
- `governance.godot_toolchain.export_templates.android_debug_member`: `"templates/android_debug.apk"` (`string`)
- `governance.godot_toolchain.export_templates.android_release_member`: `"templates/android_release.apk"` (`string`)
- `governance.godot_toolchain.export_templates.android_source_member`: `"templates/android_source.zip"` (`string`)
- `governance.godot_toolchain.export_templates.ios_member`: `"templates/ios.zip"` (`string`)
- `governance.godot_toolchain.export_templates.macos_member`: `"templates/macos.zip"` (`string`)
- `governance.godot_toolchain.export_templates.name`: `"Godot_v4.7.2-stable_export_templates.tpz"` (`string`)
- `governance.godot_toolchain.export_templates.sha512`: `"ca4d71c4d7b81dfc15d1a98baa07534aa95b03fdda78a0075b06672e1648d2e5f409...` (`string`)
- `governance.godot_toolchain.export_templates.url`: `"https://github.com/godotengine/godot/releases/download/4.7.2-stable/...` (`string`)
- `governance.godot_toolchain.export_templates.version_directory`: `"4.7.2.stable"` (`string`)
- `governance.godot_toolchain.export_templates.windows_debug_member`: `"templates/windows_debug_x86_64.exe"` (`string`)
- `governance.godot_toolchain.export_templates.windows_release_member`: `"templates/windows_release_x86_64.exe"` (`string`)
...
- `governance.risk_gates.dependency_policy.require_pip_check`: `true` (`bool`)
- `governance.risk_gates.security_ownership.enabled`: `true` (`bool`)
- `governance.risk_gates.security_ownership.max_files_below_min_authors`: `0` (`int`)
- `governance.risk_gates.security_ownership.max_files_below_target_authors_warn`: `5` (`int`)
- `governance.risk_gates.security_ownership.min_distinct_authors_per_file`: `1` (`int`)
...
- `governance.tech_debt_budget.gate_mode`: `"non_regression_baseline"` (`string`)
- `governance.tech_debt_budget.schema_version`: `1` (`int`)
- `governance.tech_debt_budget.score_epsilon`: `0.03` (`float`)
- `governance.tech_debt_budget.scoring.bug_keywords[]`: array[`string`]; examples: `"bug"`, `"regression"`, `"correctness"`
- `governance.tech_debt_budget.scoring.component_weights.backlog_bug`: `0.16` (`float`)
- `governance.tech_debt_budget.scoring.component_weights.backlog_priority`: `0.27` (`float`)
- `governance.tech_debt_budget.scoring.component_weights.ci_gate`: `0.2` (`float`)
- `governance.tech_debt_budget.scoring.component_weights.code_balance`: `0.12` (`float`)
- `governance.tech_debt_budget.scoring.component_weights.delivery_size_pressure`: `0.005` (`float`)
- `governance.tech_debt_budget.scoring.component_weights.keybinding_retention`: `0.2` (`float`)
- `governance.tech_debt_budget.scoring.component_weights.menu_simplification`: `0.05` (`float`)
- `governance.tech_debt_budget.scoring.delivery_size.file_unit`: `78` (`int`)
- `governance.tech_debt_budget.scoring.delivery_size.loc_unit`: `12500` (`int`)
- `governance.tech_debt_budget.scoring.delivery_size.source_root_weights.other`: `0.1` (`float`)
- `governance.tech_debt_budget.scoring.delivery_size.source_root_weights.scripts`: `0.2` (`float`)
- `governance.tech_debt_budget.scoring.delivery_size.source_root_weights.src/tet4d`: `1.0` (`float`)
- `governance.tech_debt_budget.scoring.delivery_size.source_root_weights.tests`: `0.35` (`float`)
- `governance.tech_debt_budget.scoring.delivery_size.source_root_weights.tools`: `0.2` (`float`)
- `governance.tech_debt_budget.scoring.normalization.bug_items_cap`: `6` (`int`)
- `governance.tech_debt_budget.scoring.normalization.ci_issue_cap`: `6` (`int`)
- `governance.tech_debt_budget.scoring.normalization.priority_points_cap`: `40` (`int`)
- `governance.tech_debt_budget.scoring.priority_weights.P1`: `5` (`int`)
- `governance.tech_debt_budget.scoring.priority_weights.P2`: `3` (`int`)
- `governance.tech_debt_budget.scoring.priority_weights.P3`: `1` (`int`)
- `governance.tech_debt_budget.status_order.critical`: `3` (`int`)
- `governance.tech_debt_budget.status_order.high`: `2` (`int`)
...
- `maintenance_contract.required_paths.root_docs[]`: array[`string`]; examples: `"README.md"`, `"docs/README.md"`, `"docs/PROJECT_STRUCTURE.md"`
- `maintenance_contract.schema_version`: `1` (`int`)
- `maintenance_contract.title`: `"tet4d canonical maintenance contract"` (`string`)
...
- `maintenance_docs.runtime_owners.Engine[]`: array[`object`]
- `maintenance_docs.runtime_owners.Engine[].description`: varies (`string`); examples: `"small compatibility facade used mainly by replay and explicit compat...`, `"gameplay convenience exports"`, `"runtime/help/menu convenience exports"`
- `maintenance_docs.runtime_owners.Engine[].path`: varies (`string`); examples: `"src/tet4d/engine/api.py"`, `"src/tet4d/engine/gameplay/api.py"`, `"src/tet4d/engine/runtime/api.py"`
- `maintenance_docs.runtime_owners.UI[]`: array[`object`]
...
- `product_platform_contract.products.godot_designer.artifact_name_token`: `"tet4d-designer"` (`string`)
...
- `product_platform_contract.products.godot_designer.icon`: `"res://assets/icons/tet4d_designer.svg"` (`string`)
- `product_platform_contract.products.godot_designer.main_scene`: `"res://scenes/designer_bootstrap.tscn"` (`string`)
- `product_platform_contract.products.godot_designer.permitted_package_role`: `"design_laboratory"` (`string`)
...
- `product_platform_contract.products.godot_game.artifact_name_token`: `"tet4d-godot-game"` (`string`)
...
- `product_platform_contract.products.godot_game.icon`: `"res://assets/icons/tet4d_game.svg"` (`string`)
- `product_platform_contract.products.godot_game.main_scene`: `"res://scenes/game_bootstrap.tscn"` (`string`)
- `product_platform_contract.products.godot_game.permitted_package_role`: `"playable_game"` (`string`)
...
- `product_platform_contract.products.python_tet4d.artifact_name_token`: `"tet4d-python"` (`string`)
