...
![Is 3D space a ceiling, or a habit?](figures/fig1-kant-vs-reid.png)
...
![Reid's geometry of visibles: a sphere centred on the eye, a great-circle "straight line", and a triangle whose angles exceed 180°](figures/fig2-visible-geometry.svg)
...
![The tesseract: a perspective projection of the 8-cell from 4D to the plane](figures/fig3-tesseract.svg)
...
![The dimensional ladder: point, line, square, cube, tesseract — each figure is the previous one dragged along a new perpendicular axis](figures/fig4-dimensional-ladder.svg)
...
![How spatial understanding is trained](figures/fig3-spatial-training.png)
...
![tet4d gameplay or sandbox screenshot](figures/fig5-tet4d-gameplay.png)
...
![The predicted learning arc — hypothesis, not data: response time for 4D fit judgments dropping from explicit translation to quasi-perceptual recognition, versus the flat Kantian ceiling](figures/fig6-learning-arc.svg)
