...
pauses ordinary Live 2D/3D/4D play on focus loss without auto-resume. R2.2
implementation is complete locally and awaits PR/CI/merge; it suspends live
timing while visible onboarding owns attention. R2.3 is next after R2.2 merges,
while R2.4 remains unstarted. Stage 56H is a gameplay/product acceptance checkpoint,
