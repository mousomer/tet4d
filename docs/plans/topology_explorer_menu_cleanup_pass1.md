...
Historical design intent only: [`docs/history/topology_playground/topology_playground_migration.md`](../history/topology_playground/topology_playground_migration.md)
