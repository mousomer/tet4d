...
- `src/tet4d/ui/pygame/locked_cell_explosion/defaults_store.py`: `ExplosionDefaults`, `default_explosion_defaults()`, `coerce_explosion_defaults(raw, *, defaults=...)`, `serialize_explosion_defaults(defaults)`, `mode_explosion_defaults(mode_key)`, `save_mode_explosion_defaults(mode_key, defaults)`
