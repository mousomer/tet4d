...
- `src/tet4d/engine/runtime/topology_persistence.py`: `PersistenceDiagnostic`, `TopologyProfileLoadResult`, `empty_topology_profile(dimension)`, `topology_profile_payload(profile)`, `topology_profiles_document(profiles)`, `load_topology_profile_document(document, dimension)`
