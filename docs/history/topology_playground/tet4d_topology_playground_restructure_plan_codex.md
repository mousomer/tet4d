...
Archived note: this document records historical migration design/background.
Current topology-playground architecture authority lives in
...
At the time this plan was written, the system had these failures:
