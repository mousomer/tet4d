...
17. For topology-playground migration/state questions, `docs/architecture/topology_playground_current_authority.md` is the current authority; older topology-playground manifests and stage plans are historical unless explicitly reactivated.
