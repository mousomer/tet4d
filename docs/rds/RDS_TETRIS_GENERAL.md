...
22. Launcher configuration IA must keep `Settings -> Controls` as persistent input configuration only; controls reference/help content must not be folded into that settings destination.
