...
1. First launch of the game build: GAME OVER with no input, the tutorial still
   ...
   ![First launch](screenshots/stage_56h_playability_review/01_first_launch_game_over.png)
2. Paused immediately after a restart. The badge still says RUNNING.
   ![Paused badge](screenshots/stage_56h_playability_review/02_paused_badge_says_running.png)
3. Main Menu, as reached from the game build.
   ![Main menu](screenshots/stage_56h_playability_review/03_main_menu.png)
4. Set-up 3D mid-game with the tutorial hidden: a small board and see-through
   locked cells.
   ![3D mid-game](screenshots/stage_56h_playability_review/04_live_3d_midgame.png)
5. Set-up 4D mid-game, with the NEXT thumbnails cut off.
   ![4D mid-game](screenshots/stage_56h_playability_review/05_live_4d_midgame_next_cut.png)
6. 4D reached with Tab: `TRACE_4D_NEXT` active, paused, and the badge still
   says RUNNING.
   ![Tab-path fixture session](screenshots/stage_56h_playability_review/06_tab_path_trace_fixture_pieces.png)
