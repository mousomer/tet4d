...
func run() -> Array:
	...
	if content != null:
		...
		_assert_section(failures, content, "Accessibility")
		_assert_section(failures, content, "Camera")
		...
		_assert_row(failures, content, "accessibility.high_contrast")
		_assert_row(failures, content, "accessibility.reduced_motion")
		_assert_row(failures, content, "accessibility.show_help_hints")
		_assert_row(failures, content, "interface.show_onboarding")
		_assert_row(failures, content, "display.window_mode")
		_assert_row(failures, content, "display.ui_scale")
		_assert_row(failures, content, "display.hud_density")
		_assert_row(failures, content, "display.board_detail")
		_assert_row(failures, content, "camera.sensitivity")
		_assert_row(failures, content, "camera.invert_y")
		_assert_node_type(failures, content.get_node_or_null("ResetDisplaySettingsButton"), Button, "settings panel should expose display reset action")
		_assert_node_type(failures, content.get_node_or_null("ResetAccessibilitySettingsButton"), Button, "settings panel should expose accessibility reset action")
