...
const MODE_STEPS := {
	...
	"live_4d": [
		{"id": "same_object", "title": "Same object, rotated view", "body": "Use one Exact camera rotation control. Watch the presentation change while the falling object stays the same.", "predicate": "basis_changed", "completion": "Same object. Exact view rotation."},
