...
from .pieces_nd import DEFAULT_RANDOM_CELL_COUNT_3D, DEFAULT_RANDOM_CELL_COUNT_4D, get_piece_shapes_nd
...
def minimal_exploration_dims_nd(
    ...
    *,
    ...
    count = _default_random_count_for_ndim(ndim) if random_cell_count is None else random_cell_count
